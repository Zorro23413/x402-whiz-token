...
/**
 * @title Whiz402TokenSmall
 * @dev Secure ERC20 token with supply cap that mints 5,000 tokens per call
 *
 * Security Features:
 ...
 */
contract Whiz402TokenSmall is ERC20, Ownable {
    // Constants
    uint256 public constant MINT_AMOUNT = 5_000 * 10**18; // 5,000 tokens with 18 decimals
    ...
    constructor() ERC20("Whiz402Small", "WHIZS") Ownable(msg.sender) {}

    /**
     * @dev Mints 5,000 tokens to the specified address
    ...
    function mint(address to) public onlyOwner {
        require(to != address(0), "Whiz402TokenSmall: mint to zero address");
        require(
            totalSupply() + MINT_AMOUNT <= MAX_SUPPLY,
            "Whiz402TokenSmall: max supply exceeded"
        );

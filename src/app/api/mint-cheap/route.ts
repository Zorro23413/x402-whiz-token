 ...
 * Protected by X402 payment middleware ($0.10 per mint)
 */
...
export const GET = async () => {
  ...
  return NextResponse.json({
    endpoint: "/api/mint-cheap",
    method: "POST",
    description: "Mint 50,000 Whiz402 tokens to any address (Budget option)",
    payment: {
      price: "$0.10",
      protocol: "x402",
    },
    ...
    example: {
      curl: `curl -X POST https://yourdomain.com/api/mint-cheap \\\\
